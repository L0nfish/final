...
$ychets = $ychet_inventMap->findAll($page*$size-$size, $size);
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <a class="btn btn-success" href="add-ychet.php">Добавить лист учёта</a>
                    <a class="btn btn-success" href="list-ychetzapr.php">Посмотреть на текущую дату</a>
                </div>
                <div class="box-body">
                    <?php
                    if ($ychets) {
